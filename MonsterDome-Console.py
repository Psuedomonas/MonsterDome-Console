...
debug_mode = True # considering the size of this file, this may be silly
...
Two monsters go in, but only one (may) come out
'''
...
def attackType():
    ...
    attack_r = random.randint(1,11) #randomly choose attack type
    
    if attack_r == (1 or 2): #bites
        att = attacks[1]
    elif attack_r == (3 or 4): #claws
        att = attacks[2]
    elif attack_r == (5 or 6): #punches
        att = attacks[3]
    elif attack_r == (7 or 8): #spits at
        att = attacks[4]
    elif attack_r == (9 or 10): #stabs tail at
        att = attacks[5]
